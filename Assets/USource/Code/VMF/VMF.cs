        ...
        public static GameObject CreateFromVMF(System.IO.Stream stream, ImportContext ctx)
        {
            ...
            GameObject CreateCSGModel(VBlock block)
            {
                ...
                foreach (IVNode node in block.Body)
                {
                    ...
                    {
                        CSGBrush brush = CreateCSGBrush(childBlock, out Layer layer);
            ...
            CSGBrush CreateCSGBrush(VBlock block, out Layer layer)
            {
                layer = Layer.Solid;
                bool disable = false;
                ...
                foreach (VBlock side in block.Body.Where((IVNode node) => { return node.Name == "side"; }))
                {
                    ...
                    {
                        resourceMaterial = UnityEngine.Resources.Load<UnityEngine.Material>("Error");
                    }
                ...
                .Where(e => e.Name == "entity"))
            {
                ...
                else  // Point entity
                {
                    ...
                    {
                        entityGO.AddComponent<UnityEngine.ReflectionProbe>();
                    }
