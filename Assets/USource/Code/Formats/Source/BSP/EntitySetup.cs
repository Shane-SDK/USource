...
//                    ResourceManager.LoadModel(ModelName, uLoader.LoadAnims, uLoader.useHitboxesOnModel).SetParent(transform, false);
//            }

//            if (uLoader.useInfoDecals && Classname.Equals("infodecal"))
//            {
//                String DecalName = Data[Data.FindIndex(n => n == "texture") + 1];
//                VMTFile DecalMaterial = ResourceManager.LoadMaterial(DecalName);
